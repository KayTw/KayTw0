...
FiveguardConfClient.AntiBulletproofTires = true
...
FiveguardConfClient.AntiAttachPedToPlayer = true
...
FiveguardConfClient.BlipsDetection = true
...
FiveguardConfClient.BlacklistedWeaponBan = false
